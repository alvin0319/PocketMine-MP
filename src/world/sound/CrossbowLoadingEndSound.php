...
final class CrossbowLoadingEndSound implements Sound{
	...
	public function encode(?Vector3 $pos) : array{
		return [LevelSoundEventPacket::create($this->quickCharge ? LevelSoundEventPacket::SOUND_CROSSBOW_QUICK_CHARGE_END : LevelSoundEventPacket::SOUND_CROSSBOW_LOADING_END, $pos)];
	}
}